...
class AppWindow(QMainWindow):
    ...
    def __init__(self, dwarf_args, flags=None):
        ...
        self.setWindowTitle(
            'Dwarf2 - A debugger for reverse engineers, crackers and security analyst'
        )
        ...
        if dwarf_args.any == '':
            ...
            self.welcome_window.setWindowTitle(
                'Welcome to Dwarf2 - A debugger for reverse engineers, crackers and security analyst'
            )
    ...
    def _on_attached(self, data):
        self.setWindowTitle('Dwarf2 - Attached to %s (%s)' % (data[1], data[0]))
